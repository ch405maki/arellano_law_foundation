                                        ...
                                        <tbody class="divide-y divide-gray-300">
                                            ...
                                            <tr v-for="post in posts" :key="post.id" class="bg-white transition-all duration-500 hover:bg-gray-50">
                                                ...
                                                <td class="p-2 flex items-center gap-2 justify-end">
                                                    <a :href="route('post.show', { id: post.id })" class="p-2 rounded-full group transition-all duration-500 flex item-center" title="Preview">
                                                    ...
                                                    <!-- Delete Button -->
                                                    <button @click="confirmDelete(post.id)" class="p-2 rounded-full hover:text-red-600 group transition-all duration-500 flex item-center active:ring-2 active:ring-offset-2 active:ring-red-600">
