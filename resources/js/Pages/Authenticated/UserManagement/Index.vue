                        ...
                        <table class="min-w-full">
                          ...
                          <tbody class="divide-y divide-gray-300">
                            ...
                            <tr v-for="user in users" :key="user.id" class="bg-white transition-all duration-500 hover:bg-gray-50">
                              ...
                              <td class="p-4">
                                <!-- Delete Button -->
                                <button @click="openDeleteModal(user)" class="p-2 rounded-full hover:text-red-600 group transition-all duration-500 flex item-center active:ring-2 active:ring-offset-2 active:ring-red-600">
...
const selectedUser = ref(null); // Store the user to be deleted
...
const deleteUser = async () => {
    ...
    try {
        ...
        // Refresh the user list (or remove the deleted user from the list)
        setTimeout(() => {
            location.reload();
        }, 2000);
    } catch (error) {
