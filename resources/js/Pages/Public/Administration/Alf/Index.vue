        ...
        <div class="flex flex-col md:flex-row justify-between gap-8">
              ...
              <div class="bg-white border-none rounded-lg mb-6 relative">
                <div class="bg-white border-none rounded-lg mb-6 relative">
                  <div class="flex flex-row sm:flex-row items-center justify-between mb-6">
                    <div class="space-y-6">
                      <!-- Icon and Introductory Text -->
                      <div class="flex items-center space-x-4">
                        <svg class="w-8 h-8 text-gray-400 dark:text-gray-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 14">
                          <path d="M6 0H2a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h4v1a3 3 0 0 1-3 3H2a1 1 0 0 0 0 2h1a5.006 5.006 0 0 0 5-5V2a2 2 0 0 0-2-2Zm10 0h-4a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h4v1a3 3 0 0 1-3 3h-1a1 1 0 0 0 0 2h1a5.006 5.006 0 0 0 5-5V2a2 2 0 0 0-2-2Z"/>
                        </svg>
                        <h1 class="text-2xl md:text-3xl lg:text-4xl font-bold text-official-purple-900">
                  ...
                  <div class="mt-8">
                    ...
                    <ol class="list-decimal list-inside space-y-4 text-base md:text-lg lg:text-lg text-gray-700 leading-relaxed">
                      ...
                      <li>To support, encourage and assist scholarships and educational undertakings in any field or all field of study through scholarship grants, lecture programs, faculty assistance and related projects and activities.</li>
                      <li>To establish, maintain and build a law library for the use not only of the Foundation and its various projects but also for the legal scholar.</li>
                    </ol>
                  </div>
                  ...
                  <div class="mt-8">
                    ...
                    <ul class="list-disc list-inside space-y-2 mt-4 text-base md:text-lg lg:text-lg text-gray-700 leading-relaxed">
                      <li>Management of the School of Law</li>
                      <li>Bar Review Program</li>
                      <li>Phoenix Program</li>
                      <li>Mandatory Continuing Legal Education (MCLE)</li>
                      <li>Guidance and Counselling Activities</li>
                      <li>Medical Services</li>
                      <li>Legal Aid Clinic through the Office of the Legal Aid</li>
                      <li>LawPhil Project</li>
                      <li>Arellano Law Journal</li>
                      <li>Scholarship Grants</li>
                      <li>Faculty Development Activities and Support</li>
          ...
          <aside class="w-full md:w-1/4 sticky top-0">
            <div class="mb-8 sm:mt-4 md:mt-8 lg:mt-10 xl:mt-12">
              <div class="ml-4">
                <h2 class="mb-4 text-lg md:text-xl lg:text-2xl font-semibold text-official-purple-900 capitalize">On this page</h2>
                <hr class="mb-4 border-1 border-official-purple-800">
                <h3 class="text-base md:text-lg lg:text-lg font-normal text-gray-800 mb-8">Arellano Law Foundation Inc.</h3>
              </div>
              <div class="ml-4">
