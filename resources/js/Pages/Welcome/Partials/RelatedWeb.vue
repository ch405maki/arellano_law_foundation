<template>
    ...
    <div class="flex flex-col items-center px-5 relative">
        <h1 class="font-bold text-lg sm:text-xl md:text-xl lg:text-2xl xl:text-2xl">Related Websites</h1>
    </div>
    <div class="flex flex-wrap justify-center items-start space-x-16 my-16">
...
const relatedLinks = ref([
    ...
    {text:'Arellano University School of Law', link: 'https://arellanolaw.edu/', image:'/images/ausllogo2.png'},
]);
</script>
